...
namespace MeetNSeat.Dal.Interfaces
{
    public class ReservationDto
    {
        ...
        public ReservationDto(int reservationId, int roomId, int userId, int feedbackId, int attendees, DateTime createdOn, DateTime startTime, DateTime endTime, DateTime confirmed)
        {
            Id = reservationId;
            RoomId = roomId;
            UserId = userId;
